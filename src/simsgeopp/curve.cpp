...
class Curve {
 private:
  ...
  std::unique_ptr<Eigen::FullPivHouseholderQR<Eigen::MatrixXd>>
      qr;  // QR factorisation of dgamma_by_dcoeff, for least squares fitting.
 ...
 public:
  ...
  Curve(Array _quadpoints) : quadpoints(_quadpoints) { numquadpoints = _quadpoints.size(); }
  ...
  void least_squares_fit(Array& target_values) {
    ...
    if (target_values.shape(1) != 3) throw std::runtime_error("Wrong third dimension for target_values. Should be 3.");
  ...
  virtual void dgammadash_by_dcoeff_impl(Array& data) {
    throw logic_error("dgammadash_by_dcoeff_impl was not implemented");
  };
  virtual void dgammadashdash_by_dcoeff_impl(Array& data) {
    throw logic_error("dgammadashdash_by_dcoeff_impl was not implemented");
  };
  virtual void dgammadashdashdash_by_dcoeff_impl(Array& data) {
    throw logic_error("dgammadashdashdash_by_dcoeff_impl was not implemented");
  };
  ...
  virtual void dtorsion_by_dcoeff_impl(Array& data) {
    throw logic_error("dtorsion_by_dcoeff_impl was not implemented");
  };
  ...
  Array& gammadashdashdash() {
    return check_the_cache("gammadashdashdash", {numquadpoints, 3},
                           [this](Array& A) { return gammadashdashdash_impl(A); });
  }

  Array& dgamma_by_dcoeff() {
    return check_the_persistent_cache("dgamma_by_dcoeff", {numquadpoints, 3, num_dofs()},
                                      [this](Array& A) { return dgamma_by_dcoeff_impl(A); });
  }
  Array& dgammadash_by_dcoeff() {
    return check_the_persistent_cache("dgammadash_by_dcoeff", {numquadpoints, 3, num_dofs()},
                                      [this](Array& A) { return dgammadash_by_dcoeff_impl(A); });
  }
  Array& dgammadashdash_by_dcoeff() {
    return check_the_persistent_cache("dgammadashdash_by_dcoeff", {numquadpoints, 3, num_dofs()},
                                      [this](Array& A) { return dgammadashdash_by_dcoeff_impl(A); });
  }
  Array& dgammadashdashdash_by_dcoeff() {
    return check_the_persistent_cache("dgammadashdashdash_by_dcoeff", {numquadpoints, 3, num_dofs()},
                                      [this](Array& A) { return dgammadashdashdash_by_dcoeff_impl(A); });
  }

  virtual Array dgamma_by_dcoeff_vjp(Array& v) { return curve_vjp_contraction<Array>(dgamma_by_dcoeff(), v); };

  virtual Array dgammadash_by_dcoeff_vjp(Array& v) { return curve_vjp_contraction<Array>(dgammadash_by_dcoeff(), v); };
  ...
  Array& dkappa_by_dcoeff() {
    return check_the_cache("dkappa_by_dcoeff", {numquadpoints, num_dofs()},
                           [this](Array& A) { return dkappa_by_dcoeff_impl(A); });
  }
  ...
  Array& dtorsion_by_dcoeff() {
    return check_the_cache("dtorsion_by_dcoeff", {numquadpoints, num_dofs()},
                           [this](Array& A) { return dtorsion_by_dcoeff_impl(A); });
  }

  Array& incremental_arclength() {
    return check_the_cache("incremental_arclength", {numquadpoints},
                           [this](Array& A) { return incremental_arclength_impl(A); });
  }

  Array& dincremental_arclength_by_dcoeff() {
    return check_the_cache("dincremental_arclength_by_dcoeff", {numquadpoints, num_dofs()},
                           [this](Array& A) { return dincremental_arclength_by_dcoeff_impl(A); });
  }
